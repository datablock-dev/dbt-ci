...
class TestTransitiveClosure:
    ...
    def test_linear_chain_collects_every_ancestor(self):
        ...
        upstream = graph["model"]["c"]["indirect_upstream_dependencies"]["node_dependencies"]
    ...
    def test_closure_includes_direct_dependencies(self):
        ...
        assert graph["model"]["b"]["indirect_upstream_dependencies"]["node_dependencies"] == {
            "model.pkg.a"
        }
    ...
    def test_downstream_closure(self):
        ...
        downstream = graph["model"]["a"]["indirect_downstream_dependencies"]["node_dependencies"]
    ...
    def test_diamond_is_not_double_counted(self):
        ...
        upstream = graph["model"]["d"]["indirect_upstream_dependencies"]["node_dependencies"]
    ...
    def test_dependencies_by_type_is_populated(self):
        ...
        by_type = graph["model"]["c"]["indirect_upstream_dependencies"]["dependencies_by_type"]

        assert by_type["model"] == {"a", "b"}
    ...
    def test_deep_chain_does_not_exhaust_the_recursion_limit(self):
        ...
        deepest = graph["model"][f"m{depth - 1}"]
    ...
    def test_cycle_terminates(self):
        ...
        upstream = graph["model"]["a"]["indirect_upstream_dependencies"]["node_dependencies"]
    ...
    def test_unknown_dependency_ids_are_retained(self):
        ...
        assert "operation.pkg.hook" in (
            graph["model"]["a"]["indirect_upstream_dependencies"]["node_dependencies"]
        )
